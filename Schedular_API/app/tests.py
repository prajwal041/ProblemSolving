...
from app.models import InterviewSlot, InterviewCalendar, InterviewConflict, Interview
...
class InterviewScheduleHandlerTestCase(TestCase):
    ...
    def test_check_day_is_valid(self):
        ...
        self.assertTrue(result,
                        'Interview day is one of the weekday for which the given slot is valid? {}'.format(result))
